...
export default function SimpleAnalysisModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-70">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-gradient-to-b from-[#1a1f3a] to-[#0f1729] rounded-lg shadow-2xl overflow-hidden border border-[#51c4ff]/30">
        <div className="sticky top-0 bg-[#1a1f3a]/80 backdrop-blur-sm px-6 py-4 flex items-center justify-end border-b border-[#51c4ff]/20">
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-[#51c4ff]/20 transition-colors"
            aria-label="Close"
          >
            ...
            <>
              <div className="grid grid-cols-4 gap-4 mb-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-[#51c4ff] font-medium">Comprehensive Analysis Report</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-[#51c4ff] font-medium">Technical Assessment Report</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-[#51c4ff] font-medium">Risk Rating Report</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-[#51c4ff] font-medium">Investment Advice Report</p>
                </div>
              </div>
