    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-70">
      <div className="relative w-full max-w-4xl bg-gradient-to-b from-[#1a1f3a] to-[#0f1729] rounded-lg shadow-2xl border border-[#51c4ff]/30 px-6 py-4">
        ...
        {!isConnecting && analysis && (
          <>
            <div className="bg-[#1a1f3a]/50 rounded-lg p-6 mb-6 border border-[#51c4ff]/20">
              <h4 className="text-lg font-semibold text-[#51c4ff] mb-3 text-center">
                Want More Detailed Analysis?
              </h4>
              <p className="text-sm text-[#51c4ff]/80 mb-4 text-center">
                Connect with us via WhatsApp to receive comprehensive analysis including technical assessment, risk rating, and personalized investment insights.
              </p>
              <div className="flex justify-center">
                ...
                >
                  ...
                  <span>Contact for Detailed Analysis</span>
                </button>
              </div>
            </div>
          </>
